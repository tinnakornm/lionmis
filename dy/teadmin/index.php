...
<?php } ?>
    ...
    <body>
        <div data-role="page" id="myPage" data-url="myPage" >
            ...
            if ($f == 0) {
                require('../../include/model-teadmin/components/page/module_machine.php');
            } elseif ($f == 1) {
                require('../../include/model-teadmin/components/page/module_sparepart.php');
            } elseif ($f == 2) {
                require('../../include/model-teadmin/components/page/module_workorder.php');
            }
            ?>
