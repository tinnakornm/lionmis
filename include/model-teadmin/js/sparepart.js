// JavaScript Document
 ...
 /** LAST UPDATE  **********
	...
	-  12/07/2016 move to packing coo teadmin project.
 ...
 //recheck form databases mt_code
  $("#spr_mtcode").on("change",function(){
		...
		var dataString = 'spr_mtcode='+spr_mtcode+'&flag=142';
	      $.ajax({ type: "POST", url: "http://lionproduction.sli/pdmis/include/model-teadmin/components/service/ajax_check_mtcode.php",
