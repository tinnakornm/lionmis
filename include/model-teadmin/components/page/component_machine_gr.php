...
<div data-role="content" style="  padding-left: 20px;" >
  ...
  <div style="float:left; font-size:24px; padding-top:15px;  padding-bottom:10px;"><strong> <a href="http://lionproduction.sli/pdmis/<?php echo $dev_root; ?>/teadmin/index.php?f=0&mn=1" data-ajax="false"> กลุ่มเครื่องจักร </a>&raquo;  <?php echo $arrgr['item_name']; ?></strong></div>
  <div id="info"></div>
 ...
 <div id="tabs">
  <ul>
    ...
    <li><a href="components/page/subpast/tab_machine_gr_manual.php">ข้อมูลพื้นฐาน</a></li>
  ...
  <tr>
	...
	<?php
	 ...
	 <a href="http://lionproduction.sli/pdmis/coo/teadmin/index.php?f=1&mn=1&gr='.$arrg['sprg_name'].'" data-ajax="false">'.$arrg['sprg_name'].'</a>
	  </div>
	...
	'; 
		...
		while($arrm = mysql_fetch_array($q2)){
			echo '<div> SAP ID :  <a href="?f=2&gr='.$arrm['item_id'].'"> &raquo; '.$arrm['sap_id'].'</a></div>';
			echo '<div> ชื่องเครื่องจักร :  <a href="?f=2&gr='.$arrm['item_id'].'"> &raquo; '.$arrm['item_name'].'</a></div>';
			echo '<div> รหัสเครื่องจักร :  <a href="?f=2&gr='.$arrm['item_id'].'"> &raquo; '.$arrm['item_name'].'</a></div>';
