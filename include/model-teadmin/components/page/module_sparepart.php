...
<table  border="0" cellpadding="0" style=" width: 100%;">
 ...
 <td style="margin:1px;" width="12%" ><a  style="width:90%;"  data-ajax="false"  href="?f=1&amp;mn=1"  class="ui-btn ui-btn-inline <?php if($mn==1){ echo 'ui-link ui-btn ui-btn-active'; } ?> " > Special Type </a></td>
  <td  style="margin:1px;"  width="12%"><a  data-ajax="false" style="width:90%;"  href="?f=1&amp;mn=2"  class="ui-btn ui-btn-inline <?php if($mn==2){ echo 'ui-link ui-btn ui-btn-active'; } ?> " > General Type  </a></td>
...
<div data-role="content">
  ...
  <div style="float:left; font-size:24px; padding-top:15px;  padding-bottom:10px;"><strong>&raquo; <?php if($mn==1){ echo 'Special'; }else{ echo 'General'; } ?> Sparepart of <?php echo $dev_v1; ?></strong></div>
  <div id="info"></div>
 <div style="text-align:right; float:right;">
  ...
  <div style="margin-top:60px;  padding-bottom:5px;"> Spare Part <?php if($mn==1){ echo ' เฉพาะกลุ่มเครื่องจักร  '; }else{ echo 'ทั่วไปหมวหมู่ '; } ?><?php echo $gr; ?> - <?php echo $sprg_describ; ?></div>
  <div style="text-align:center; padding:5px; background-color:#CEE1F7;">
      <form id="form1" name="form1" method="get" action="?f=1?mn=<?php echo $mn; ?>" data-ajax="false"   >
      <input name="f" type="hidden" value="1" />
        ...
        <select data-role="none" name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
		 ...
		 if($mn==1){//special 
		  ...
		  ?>
          <option value="?f=1&mn=<?php echo $mn; ?>&gr=<?php echo $arrg['sprg_name']; ?>" <?php if($gr==$arrg['sprg_name']){ echo 'selected="selected"'; } ?>><?php if($arrg['sub_gr']!=""){ echo $arrg['sub_gr'].'->'; } echo $arrg['sprg_name']; ?></option>
          <?php }//end while ?>
