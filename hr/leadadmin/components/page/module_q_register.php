...
<table  border="0" cellpadding="0" style=" width: 100%;">
 ...
 <td style="margin:1px;" width="12%" ><a  style="width:90%;"  data-ajax="false"  href="../../../leadamin/components/page/?f=2&amp;mn=1"  class="ui-btn ui-btn-inline <?php if($mn==1){ echo 'ui-link ui-btn ui-btn-active'; } ?> " > ใบแจ้งซ่อม </a></td>
  <td  style="margin:1px;"  width="12%"><a  data-ajax="false" style="width:90%;"  href="../../../leadamin/components/page/?f=2&amp;mn=2"  class="ui-btn ui-btn-inline <?php if($mn==2){ echo 'ui-link ui-btn ui-btn-active'; } ?> " > คิวงานซ่อม  </a></td>
...
<!--//End sub menu -->
 ...
 <?php
   if($mn==1){
  include("../../../leadamin/components/page/component_workorder.php");
  }else{
  include("../../../leadamin/components/page/component_workorder_q.php");
  }
