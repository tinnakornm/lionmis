...
<body>
<form action= "saveedit.php?id=<?php echo $_GET["id"] ?>" target="_blank" name="frmEdit" method="post" >
<?php
...
<table width="600" border="1">
  <tr>
   <th width="20"> <div align="center">ID </div></th>
    <th width="50"> <div align="center">PD Group </div></th>
    ...
    <th width="80"> <div align="center">Fullformula </div></th>
     <th width="55"> <div align="center">Mixer </div></th> 
  ...
  <tr>
    ...
    <td><input type="text" name="txtpdgroup" size="20" value="<?php echo $objResult["pd_group"];?>"></td>
    <td><input type="text" name="txtprocess" size="20" value="<?php echo $objResult["process"];?>"></td>
    <td><div align="center"><input type="text" name="txtformula" size="2" value="<?php echo $objResult["formula"];?>"></div></td>
    <td align="right"><input type="text" name="txtversion" size="5" value="<?php echo $objResult["version"];?>"></td>
    <td align="right"><input type="text" name="txtfullformula" size="5" value="<?php echo $objResult["fullformula"];?>"></td>
     <td align="right"><input type="text" name="txtmixer" size="5" value="<?php echo $objResult["mixer"];?>"></td>
  ...
  <div  align="center">
<input align="middle" type="submit" name="submit"  value="submit" />
</div>
<?php
  }
